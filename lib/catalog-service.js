    ...
    rules: [
      {
        ...
        systemContext: "ZA Business Rules: Only South African contacts (country='ZA') are permitted on this portal. Requires South African ID (13 digits) and 4-digit postal code.",
        suggestedPrompts: [
      ...
      },
      {
        ...
        systemContext: "ES Business Rules: Only Spanish contacts (country='ES') are permitted on this portal. Requires valid DNI/NIE/NIF document and Spanish 5-digit postal code (CP).",
        suggestedPrompts: [
      ...
      },
      {
        ...
        systemContext: "CA Business Rules: Only Canadian contacts (country='CA') are permitted on this portal. Requires Social Insurance Number (SIN 9 digits) and alphanumeric Postal Code (A1A 1A1).",
        suggestedPrompts: [
